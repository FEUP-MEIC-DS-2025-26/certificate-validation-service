...
async function verifyCertificate(productId: string) {
	const requestPage = new Request("https://www.iscc-system.org/certification/certificate-database/all-certificates/", {
		method: "GET",
	});
	...
	return responseJson["data"].length == 1 && responseJson["data"][0][1] == productId;
}
